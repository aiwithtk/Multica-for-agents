...
| Opération | Coût (unités) | Endpoint API |
|-----------|---------------|----------------|
| **Écritures** | **50** | `comments.insert`, `commentThreads.insert`, `videos.rate`, `comments.delete`, `videos.reportAbuse`, `comments.setModerationStatus`, `YOUTUBE_UPDATE_COMMENT` |
